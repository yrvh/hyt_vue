<template>
  <div class="detail-company">
    ...
    <van-cell-group title="公司基本信息">
      ...
      <van-cell title="营业执照" is-link border center @click="onPhoto([detail.yyzzurl])" />
    ...
    <van-cell-group title="法定代表人信息">
      ...
      <van-cell title="证件照片" is-link border center @click="onPhoto([detail.fr_cardupurl,detail.fr_carddownurl])" />
    ...
    <van-cell-group v-if="detail.ishave_lxr" title="联系人信息">
      ...
      <van-cell title="证件照片" is-link border center @click="onPhoto([detail.lxr_cardupurl,detail.lxr_carddownurl])" />
