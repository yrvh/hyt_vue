<template>
  <div class="income">
    ...
    <van-tabs type="card" color="#7EB6FF" v-model="tab_mark" animated swipeable scrollspy @change="onChange">
      <!--     收入管理(业者)       -->
      <van-tab title="业者" :badge="free_income[0].value==0? '':free_income[0].value">
      ...
      <!--     收入管理(合伙人)    -->
      <van-tab title="合作伙伴" :badge="coop_income[0].value==0? '':coop_income[0].value">
      ...
      <!--     收入管理(边民合作社)       -->
      <van-tab title="合作社" :badge="frontier_income[0].value==0? '':frontier_income[0].value">
