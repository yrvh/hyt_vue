...
export const SETHM = 'setHhr_ms_xieyi'
export const SETMS = 'setMs_xieyi'

export const SETLG = 'setLogo'
export const SETLC = 'setLicense'
export const SETCF = 'setFront'
export const SETCB = 'setBehind'

// 记住密码
export const SETMEM = 'setMemory'
